...
int main(int argc, char **argv)
{
    ...
    if (parser.isSet(i18n("demo"))) {
        ...
        AlphaDots::SelfPlay *selfPlay = new AlphaDots::SelfPlay(datasetDest, threads, initialModelName, targetModelName, iterationCnt, iterationSize, logDest, epochs, gpuTraining, datasetType);
        selfPlay->show();
    } else {
