...
int main(int argc, char **argv)
{
    ...
    parser.addOption(QCommandLineOption(QStringList() <<  i18n("debug"), i18n("Print debug output"), i18n("debug")));
    parser.addOption(QCommandLineOption(QStringList() <<  i18n("batch-prediction"), i18n("Enable batch prediction (not recommended)")));
