...
# changed by Tom Vincent Peters <kde@vincent-peters.de>,  2015
...
if __name__ == '__main__':
	parser = argparse.ArgumentParser(description='Send request to QDab server')
	...
	for i in range(2):
			for n in range(30):
					if ((1<<n)&ms[i]) != 0:
							theMove = dab.num2move(((1<<n)|(i<<31)), 1, 1)
